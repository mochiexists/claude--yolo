...
Survives other tools that redefine `claude()` (terminal multiplexers, shell integrations, etc.) by using a precmd hook that re-wraps after clobbering. Re-running the installer updates to the latest version in-place.
